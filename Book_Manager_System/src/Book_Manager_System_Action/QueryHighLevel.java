...
public class QueryHighLevel extends ActionSupport{
	...
	public void queryHighLevel() throws IOException{
		...
		//ArrayList<Book> list=(ArrayList<Book>) Bookcontrol.querySimple(bookName);
		ArrayList<Stock_Size> list=(ArrayList<Stock_Size>) Bookcontrol.queryHighLevel(book_name, book_author, 
